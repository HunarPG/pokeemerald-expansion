...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_TWINLEAF_TOWN] = {MAP_GROUP(MAP_TWIN_LEAF_TOWN), MAP_NUM(MAP_TWIN_LEAF_TOWN), HEAL_LOCATION_TWIN_LEAF_TOWN},
    ...
    [MAPSEC_OREBURGH_CITY] = {MAP_GROUP(MAP_OREBURGH_CITY), MAP_NUM(MAP_OREBURGH_CITY), HEAL_LOCATION_OREBURGH_CITY},
};

...
const u8 gText_DefaultNameKenny[] = _("Keny");
...
const u8 gText_DexSortTallestTitle[] = _("Talltest Mode");
...
const u8 gText_LeagueChamp[] = _("Leauge Champion!\nCongratulations!");
...
const u8 gText_CheckMapOfSinnoh[] = _("Check the map of the SINNOH region.");
...
const u8 gText_DexSinnoh[] = _("SINNOH");

...
static void QueueAnimTiles_FRLG_General_Water(u16);
...
const u16 gTilesetAnims_FRLG_General_Water_Frame0[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/0.4bpp");
const u16 gTilesetAnims_FRLG_General_Water_Frame1[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/1.4bpp");
const u16 gTilesetAnims_FRLG_General_Water_Frame2[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/2.4bpp");
const u16 gTilesetAnims_FRLG_General_Water_Frame3[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/3.4bpp");
const u16 gTilesetAnims_FRLG_General_Water_Frame4[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/4.4bpp");
const u16 gTilesetAnims_FRLG_General_Water_Frame5[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/5.4bpp");
const u16 gTilesetAnims_FRLG_General_Water_Frame6[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/6.4bpp");
const u16 gTilesetAnims_FRLG_General_Water_Frame7[] = INCBIN_U16("data/tilesets/primary/frlg_general/anim/water_current_landwatersedge/7.4bpp");

const u16 *const gTilesetAnims_FRLG_General_Water[] = {
    gTilesetAnims_FRLG_General_Water_Frame0,
    gTilesetAnims_FRLG_General_Water_Frame1,
    gTilesetAnims_FRLG_General_Water_Frame2,
    gTilesetAnims_FRLG_General_Water_Frame3,
    gTilesetAnims_FRLG_General_Water_Frame4,
    gTilesetAnims_FRLG_General_Water_Frame5,
    gTilesetAnims_FRLG_General_Water_Frame6,
    gTilesetAnims_FRLG_General_Water_Frame7,
};
...
{
    if (timer % 16 == 0)
        QueueAnimTiles_FRLG_General_Water(timer / 16);
}

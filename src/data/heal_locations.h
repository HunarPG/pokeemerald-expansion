static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 52, 40},
    [HEAL_LOCATION_ETERNA_CITY - 1] = {MAP_GROUP(ETERNA_CITY), MAP_NUM(ETERNA_CITY), 18, 21},
    [HEAL_LOCATION_CANALAVE_CITY - 1] = {MAP_GROUP(CANALAVE_CITY), MAP_NUM(CANALAVE_CITY), 28, 14},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 46, 18},
    [HEAL_LOCATION_SOLACEON_TOWN - 1] = {MAP_GROUP(SOLACEON_TOWN), MAP_NUM(SOLACEON_TOWN), 24, 16},
    [HEAL_LOCATION_SINNOH_POKEMON_LEAUGE - 1] = {MAP_GROUP(SINNOH_POKEMON_LEAUGE), MAP_NUM(SINNOH_POKEMON_LEAUGE), 10, 64},
};

static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TWIN_LEAF_TOWN - 1] = {MAP_GROUP(TWIN_LEAF_TOWN), MAP_NUM(TWIN_LEAF_TOWN), 9, 10},
    ...
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 30, 21},

static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 19, 12},
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 17, 15},
    [HEAL_LOCATION_ETERNA_CITY - 1] = {MAP_GROUP(ETERNA_CITY), MAP_NUM(ETERNA_CITY), 30, 21},
    [HEAL_LOCATION_CANALAVE_CITY - 1] = {MAP_GROUP(CANALAVE_CITY), MAP_NUM(CANALAVE_CITY), 10, 21},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 46, 17},
    [HEAL_LOCATION_SOLACEON_TOWN - 1] = {MAP_GROUP(SOLACEON_TOWN), MAP_NUM(SOLACEON_TOWN), 34, 16},
    [HEAL_LOCATION_SINNOH_POKEMON_LEAUGE - 1] = {MAP_GROUP(SINNOH_POKEMON_LEAUGE), MAP_NUM(SINNOH_POKEMON_LEAUGE), 15, 32},
};

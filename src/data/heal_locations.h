static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_TWIN_LEAF_TOWN - 1] = {MAP_GROUP(TWIN_LEAF_TOWN), MAP_NUM(TWIN_LEAF_TOWN), 20, 19},
    [HEAL_LOCATION_ROUTE201 - 1] = {MAP_GROUP(ROUTE201), MAP_NUM(ROUTE201), 31, 13},
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 19, 11},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 46, 18},
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 52, 39},
    [HEAL_LOCATION_FLOROMA_TOWN - 1] = {MAP_GROUP(FLOROMA_TOWN), MAP_NUM(FLOROMA_TOWN), 16, 59},
    [HEAL_LOCATION_HEART_HOME_CITY - 1] = {MAP_GROUP(HEART_HOME_CITY), MAP_NUM(HEART_HOME_CITY), 34, 41},
    [HEAL_LOCATION_ETERNA_CITY - 1] = {MAP_GROUP(ETERNA_CITY), MAP_NUM(ETERNA_CITY), 35, 20},
    ...
    [HEAL_LOCATION_VEIL_STONE_CITY - 1] = {MAP_GROUP(VEIL_STONE_CITY), MAP_NUM(VEIL_STONE_CITY), 10, 10},
    [HEAL_LOCATION_PASTORIA_CITY - 1] = {MAP_GROUP(PASTORIA_CITY), MAP_NUM(PASTORIA_CITY), 32, 36},
    [HEAL_LOCATION_SINNOH_POKEMON_LEAUGE - 1] = {MAP_GROUP(SINNOH_POKEMON_LEAUGE), MAP_NUM(SINNOH_POKEMON_LEAUGE), 16, 27},
    [HEAL_LOCATION_SUNNYSHORE_CITY - 1] = {MAP_GROUP(SUNNYSHORE_CITY), MAP_NUM(SUNNYSHORE_CITY), 35, 32},
};

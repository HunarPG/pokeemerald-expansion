static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SANDGEM_TOWN - 1] = {MAP_GROUP(SANDGEM_TOWN), MAP_NUM(SANDGEM_TOWN), 17, 16},
    [HEAL_LOCATION_OREBURGH_CITY - 1] = {MAP_GROUP(OREBURGH_CITY), MAP_NUM(OREBURGH_CITY), 32, 27},
    [HEAL_LOCATION_JUBILIFE_CITY - 1] = {MAP_GROUP(JUBILIFE_CITY), MAP_NUM(JUBILIFE_CITY), 34, 27},
    [HEAL_LOCATION_FLOROMA_TOWN - 1] = {MAP_GROUP(FLOROMA_TOWN), MAP_NUM(FLOROMA_TOWN), 16, 52},
};

...
const struct Tileset gTileset_pastoria_city =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_pastoria_city,
    .palettes = gTilesetPalettes_pastoria_city,
    .metatiles = gMetatiles_pastoria_city,
...
const struct Tileset gTileset_sinnoh_mart =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_sinnoh_mart,
    .palettes = gTilesetPalettes_sinnoh_mart,
    .metatiles = gMetatiles_sinnoh_mart,

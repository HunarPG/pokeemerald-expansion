...
static const enum NationalDexOrder sKantoToNationalOrder[KANTO_DEX_COUNT] =
{
    ...
    KANTO_TO_NATIONAL(KRICKETOT),
    KANTO_TO_NATIONAL(KRICKETUNE),
    ...
    KANTO_TO_NATIONAL(BURMY),
    KANTO_TO_NATIONAL(WORMADAM),
    KANTO_TO_NATIONAL(MOTHIM),
    ...
    KANTO_TO_NATIONAL(GLAMEOW),
    KANTO_TO_NATIONAL(PURUGLY),
    KANTO_TO_NATIONAL(GOLDEEN),
    KANTO_TO_NATIONAL(SEAKING),
    KANTO_TO_NATIONAL(BARBOACH),
    KANTO_TO_NATIONAL(WHISCASH),
    KANTO_TO_NATIONAL(BASCULIN),
    KANTO_TO_NATIONAL(BASCULEGION),
    KANTO_TO_NATIONAL(CHINGLING),
    ...
    KANTO_TO_NATIONAL(ROWLET),
    KANTO_TO_NATIONAL(DARTRIX),
    KANTO_TO_NATIONAL(DECIDUEYE),
    ...
    KANTO_TO_NATIONAL(FINNEON),
    KANTO_TO_NATIONAL(LUMINEON),
    ...
    KANTO_TO_NATIONAL(BERGMITE),
    KANTO_TO_NATIONAL(AVALUGG),
    KANTO_TO_NATIONAL(ZORUA),
    KANTO_TO_NATIONAL(ZOROARK),
    ...
    KANTO_TO_NATIONAL(TORNADUS),
    KANTO_TO_NATIONAL(THUNDURUS),
    KANTO_TO_NATIONAL(LANDORUS),
    KANTO_TO_NATIONAL(ENAMORUS),
    KANTO_TO_NATIONAL(DIALGA),
    KANTO_TO_NATIONAL(PALKIA),
    KANTO_TO_NATIONAL(GIRATINA),
    KANTO_TO_NATIONAL(ARCEUS),

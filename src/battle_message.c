...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_YOUTHROWABALLNOWRIGHT]                = COMPOUND_STRING("Ok! Its HP is down! I… It's ready for a Poke Ball!"),
...
static const u8 *BattleStringGetPlayerName(u8 *text, u8 battler)
{
    ...
    case B_POSITION_PLAYER_RIGHT:
        ...
        {
            /*if (gBattlePartners[gPartnerTrainerId - TRAINER_PARTNER(PARTNER_NONE)].trainerPic == TRAINER_PIC_BACK_BRENDAN
                || gBattlePartners[gPartnerTrainerId - TRAINER_PARTNER(PARTNER_NONE)].trainerPic == TRAINER_PIC_BACK_MAY)
            {

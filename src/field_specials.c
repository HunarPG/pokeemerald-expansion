...
void LoadWallyZigzagoon(void)
{
    ...
    {
        case 0:
            CreateRandomMon(&gParties[B_TRAINER_PLAYER][0], SPECIES_PIPLUP, 5);
            break;
        case 1:
            CreateRandomMon(&gParties[B_TRAINER_PLAYER][0], SPECIES_TURTWIG, 5);
            break;
        case 2:
            CreateRandomMon(&gParties[B_TRAINER_PLAYER][0], SPECIES_CHIMCHAR, 5);
            break;
    }
}

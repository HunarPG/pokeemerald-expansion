...
#define VAR_RIVAL_MOM_TEXT                               0x4052
...
#define VAR_GOT_STARTER                                  0x4059 // 0 = Didn't get starter yet, 1 = Got Starter but didn't go to lake, 2 = Got the starter and went to lake

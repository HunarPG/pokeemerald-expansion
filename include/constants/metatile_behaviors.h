...
#define MB_UNUSED_EB 0xF0
#define MB_UNUSED_EC 0xF1
#define MB_UNUSED_ED 0xF2
#define MB_UNUSED_EE 0xF3
#define MB_ROCK_CLIMB 0xF4

#define NUM_METATILE_BEHAVIORS 0xF5
